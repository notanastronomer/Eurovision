...
dyadseighties<- subset(dyadseighties, eighties.avg > 0.155)
dyadsnineties <- subset(dyadsnineties, nineties.avg > 0.155)
dyadstwothousands <- subset(dyadstwothousands, twothousands.avg > 0.155)
dyadstwentytens <- subset(dyadstwentytens, twentytens.avg > 0.155)
